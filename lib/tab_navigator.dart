...
import 'package:wechat_book/content_pager.dart';

class TabNavigaror extends StatefulWidget {
  @override
  _TabNavigarorState createState() => _TabNavigarorState();
}

class _TabNavigarorState extends State<TabNavigaror> {
